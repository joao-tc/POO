...
import auxi.Stack;
import garagem.GaragemLocomotiva;
import garagem.GaragemVagao;
...
public class Main {
    ...
    /*Declaracao de variaveis*/
        ...
        public static int nComposicoes = 0;

    /*Main*/
    public static void main(String[] args) {
        composicoes = new Stack[10];
        GaragemLocomotiva.initLocomotiva();
        GaragemVagao.initVagao();
    ...
    public static void menu() {
        ...
        switch(x) {
            case 1: // Criar nova composicao
                ...
                printLocomotivas();
                y = in.nextInt();
                composicoes[index].push(GaragemLocomotiva.locomotivas.get(y));
                nComposicoes++;
                editComp(index);
                break;
    ...
    public static void printLocomotivas() {
        for(int i = 0; i < GaragemLocomotiva.locomotivas.size(); i++) {
            System.out.println(GaragemLocomotiva.locomotivas.get(i).toString());
        }
    }

    public static void printVagoes() {
        for(int i = 0; i < GaragemVagao.vagoes.size(); i++) {
            System.out.println(GaragemVagao.vagoes.get(i).toString());
        }
    }
        ...
        while(true) {
            ...
            switch(x) {
                ...
                case 2:
                    ...
                    printVagoes();
                    y = in.nextInt();
                    composicoes[index].push(GaragemVagao.vagoes.get(y));
                    break;
